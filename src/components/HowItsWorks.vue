...
<template>
  <section
    id="features"
    class="container px-10 mx-auto py-24 sm:py-32 hero"
  >
    <div class="text-center mb-8">
      ...
      <h3 class="text-3xl text-color md:text-4xl text-center font-black">
    ...
    <div class="lg:w-[80%] mx-auto relative">
      ...
      >
        <Card class="h-full bg-transparent border-0 shadow-none">
          ...
          <CardContent class="text-foreground font-bold w-[80%]">
            {{ description }}
          </CardContent>
        </Card>
